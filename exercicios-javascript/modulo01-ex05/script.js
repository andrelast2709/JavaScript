// EXERCÍCIO 05 | MÓDULO 1
// Objetivo: usar template strings (crase + ${}) em vez de concatenação com +.

const nome = "Marina";
const turma = "2º ano B";
const nota = 9;

// Tarefa 1: usando template string (crase `` e ${}), monte e mostre no console a frase:
...
//         chamada "anoAtual" com o ano atual. Use template string para mostrar:
